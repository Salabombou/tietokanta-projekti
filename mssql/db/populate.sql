...
-- Note: You need to know the IDs of the recipes and ingredients to insert these records
...
-- Note: You need to know the IDs of the recipes and hardware to insert these records
...
-- Note: You need to know the IDs of the recipes and categories to insert these records
